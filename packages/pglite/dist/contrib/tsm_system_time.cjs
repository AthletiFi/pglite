...
var tsm_system_time_exports = {};
__export(tsm_system_time_exports, {
  tsm_system_time: () => tsm_system_time
});
module.exports = __toCommonJS(tsm_system_time_exports);
...
//# sourceMappingURL=tsm_system_time.cjs.map