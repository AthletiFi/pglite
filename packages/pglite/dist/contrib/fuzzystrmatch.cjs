...
var fuzzystrmatch_exports = {};
__export(fuzzystrmatch_exports, {
  fuzzystrmatch: () => fuzzystrmatch
});
module.exports = __toCommonJS(fuzzystrmatch_exports);
...
var setup = async (_pg, _emscriptenOpts) => {
  return {
    bundlePath: new URL("../../release/fuzzystrmatch.tar.gz", importMetaUrl)
  };
};
var fuzzystrmatch = {
  name: "fuzzystrmatch",
