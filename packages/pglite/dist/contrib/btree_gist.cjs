...
var btree_gist_exports = {};
__export(btree_gist_exports, {
  btree_gist: () => btree_gist
});
module.exports = __toCommonJS(btree_gist_exports);
...
var setup = async (_pg, _emscriptenOpts) => {
  return {
    bundlePath: new URL("../../release/btree_gist.tar.gz", importMetaUrl)
  };
};
var btree_gist = {
  name: "btree_gist",
