...
var adminpack_exports = {};
__export(adminpack_exports, {
  adminpack: () => adminpack
});
module.exports = __toCommonJS(adminpack_exports);
...
var setup = async (_pg, _emscriptenOpts) => {
  return {
    bundlePath: new URL("../../release/adminpack.tar.gz", importMetaUrl)
  };
};
var adminpack = {
  name: "adminpack",
...
//# sourceMappingURL=adminpack.cjs.map