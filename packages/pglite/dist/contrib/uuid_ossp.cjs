...
var uuid_ossp_exports = {};
__export(uuid_ossp_exports, {
  uuid_ossp: () => uuid_ossp
});
module.exports = __toCommonJS(uuid_ossp_exports);
...
var setup = async (_pg, _emscriptenOpts) => {
  return {
    bundlePath: new URL("../../release/uuid-ossp.tar.gz", importMetaUrl)
  };
};
var uuid_ossp = {
  name: "uuid-ossp",
...
//# sourceMappingURL=uuid_ossp.cjs.map